...
После добавления кода в проект с решением задачи необходимо настроить его интеграцию с одной из систем CI на выбор: Github Actions ([инструкция](https://github.com/netology-code/aqa-homeworks/blob/master/github-actions-integration)) или AppVeyor ([инструкция](https://github.com/netology-code/aqa-homeworks/blob/master/appveyor-integration)).    
